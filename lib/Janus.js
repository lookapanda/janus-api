...
class Janus {
    ...
    connect() {
        ...
        return new Promise((resolve, reject) => {
            this.ws = new (WebSocket_1.default()(this.config.url, this.protocol))();
            ...
            this.ws.addEventListener('open', () => {
                ...
                const transaction = v4_1.default();
    ...
    transaction(type, payload, replyType, timeoutMs) {
        ...
        const transactionId = v4_1.default();
        return new Promise((resolve, reject) => {
            if (timeoutMs) {
                setTimeout(() => {
    ...
    send(type, payload) {
        return new Promise((resolve, reject) => {
            ...
            const request = Object.assign({}, payload, { janus: type, session_id: this.sessionId, transaction: v4_1.default() });
